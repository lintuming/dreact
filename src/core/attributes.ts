import * as Dreact from "./types";

export interface DreactAttributes {
  key?: Dreact.Key;
}

export interface DreactClassAttributes<T = any> extends DreactAttributes {
  ref?: Dreact.Ref<T>;
}
...
export interface DreactDomAttrs {
  children?: Dreact.ComponentChildren;
  dangerouslySetInnerHTML?: {
    __html: string;
  };
}
interface DOMAttributes extends DreactDomAttrs {
  // Image Events
...
export interface HTMLAttributes
  extends DreactClassAttributes<any>,
    DOMAttributes {
